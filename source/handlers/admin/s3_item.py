...
from source.database.queries import (
    ...
    get_subcategory_name, add_item, get_available_items_by_subcategory,
    get_item_by_id, edit_item_code, delete_single_item,
...
async def show_subcategories_for_item(callback: CallbackQuery, state: FSMContext, cat_id: int, page: int):
    ...
    if not subs:
        await callback.message.edit_text("❌ Belum ada subkategori di kategori ini.",
